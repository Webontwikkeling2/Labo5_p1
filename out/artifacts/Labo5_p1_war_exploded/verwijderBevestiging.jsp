...
<main id="container">
    <article>
        ...
        <p>Ben je zeker dat je de student <%=request.getParameter("naam")%> <%=request.getParameter("voornaam")%> wil verwijderen?</p>
        <form action="StudentInfo?command=delete" method="post">
            <input style="display: none;" disabled name="naam" value="<%=request.getParameter("naam")%>">
            <input style="display: none;" disabled name="voornaam" value="<%=request.getParameter("voornaam")%>">
